  ...
  return (
    <div className="flex items-center justify-center space-x-4 md:space-x-8 mb-10">
      <div className="flex items-center">
        <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-semibold text-sm md:text-base ${number>=1 ? "bg-gradient-to-r from-[#1F1F6F] to-[#14274E] text-white" : "bg-gray-200 text-gray-500"} `}>
          1
        </div>
      ...
      <div className="flex items-center">
        <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-semibold text-sm md:text-base ${number>=2 ? "bg-gradient-to-r from-[#1F1F6F] to-[#14274E] text-white" : "bg-gray-200 text-gray-500"} `}>
          2
        </div>
      ...
      <div className="flex items-center">
        <div className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center font-semibold text-sm md:text-base ${number>=3 ? "bg-gradient-to-r from-[#1F1F6F] to-[#14274E] text-white" : "bg-gray-200 text-gray-500"} `}>
          3
        </div>
