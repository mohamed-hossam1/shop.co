...
export default async function ProductDetails({ id }: { id: string }) {
  const { data: product }: { data: ProductData } =
    ...
    <div className="max-w-[1450px] px-5 m-auto mt-12">
      <div className="w-11/12 m-auto">
        ...
        <div className="mb-10">
          ...
          <h2 className="pt-4 text-xl font-semibold whitespace-pre-line">{product.description}</h2>
        </div>
         <div className="mb-20">
          <div className="flex border-b ">
            <span className="py-1 text-lg text-primary border-b-2 border-primary font-medium ">
          ...
          <h2 className="pt-4 text-xl font-semibold whitespace-pre-line">{product.ingredients}</h2>
        </div>
